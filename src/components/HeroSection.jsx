    ...
    return (
        <>
         <section className='container'>
            {/* <div className='' style={{ backgroundImage: `url(${HeroImage})` }}>  */}
                    ...
                    {/* <img src={HeroImage} /> */}
                        ...
                        <a className='btn-green'><span className=' text-gradiant-green font-extrabold text-2xl'>Browse Live Contests</span></a>
                    </div>
               {/* </div> */}
            </section>
        </>)
